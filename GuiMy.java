...
public class GuiMy{
    ...
    private  int[][] playfild = new int[10][10];
    private String name;
    private int paluba;
    private JLabel lab;
    private JLabel lab1;
 ...
 Ship shipfour = new Ship("Four", playfild);
 Ship ship30 = new Ship(33, playfild);
 Ship ship31 = new Ship(33, playfild);
 Ship ship20 = new Ship("Two", 22, playfild);
 Ship ship21 = new Ship("Two1", 22, playfild);
 Ship ship22 = new Ship("Two2", 22, playfild);
 Ship ship1 = new Ship(playfild);
 Ship ship2 = new Ship(playfild);
 Ship ship3 = new Ship(playfild);
 Ship ship4 = new Ship(playfild);
